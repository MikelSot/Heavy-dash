...
<div class="modal fade" id="viewShippingEmployee" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title" id="exampleModalLabel">Envios realizado por ${employee.firstName}</h5>
                ...
                <div class="table-responsive">
                    <table id="tableEmployee2" class="table display nowrap table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <c:forEach var="chippingEmployees" items="${selectChippingEmployeeID}" varStatus="statusNumber">
