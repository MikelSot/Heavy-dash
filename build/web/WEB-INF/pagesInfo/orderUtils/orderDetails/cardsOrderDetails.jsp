...
<div class="row">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-info shadow h-100 py-1">
            <div class="card-body" data-toggle="modal" data-target="#viewSelectOrderDetailsOrders" type="button">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-warning shadow h-100 py-1">
            <div class="card-body" data-toggle="modal" data-target="#viewSelectOrderDetailsProduct" type="button">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                            ${totalSelectOrderDetailsProduct}
                        </div>
                    </div>
                    <div class="col-auto">
...
<div class="d-sm-flex align-items-center justify-content-between">
    <h1 class="mb-0 text-gray-800">Detalle Pedidos Clientes </h1>
</div>
...
<button
    ...
    data-toggle="modal"
    data-target="#insertOrderDetails"
    >
